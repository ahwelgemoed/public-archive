    ...
    return !this.state.fontLoaded ? (
      ...
      >
        <Grid style={{}}>
          <Col style={{ width: '40%' }}>
            ...
            <Row>
                ...
                >
                  <View>
                    {this.state.isPlaying ? (
                      <MaterialIcons name="pause" size={40} color="#c2c2c2" />
                    ) : (
                      <MaterialIcons
                        name="play-arrow"
                        size={40}
              ...
              <Col>
                ...
                >
                  <View>
                    <MaterialIcons name="stop" size={40} color="#c2c2c2" />
                  </View>
                </TouchableHighlight>
              </Col>
            </Row>
          ...
          <Col style={{ width: '60%' }}>
            <FeatNamePodName>{this.state.playbackInstanceName}</FeatNamePodName>
          </Col>
        </Grid>
      ...
      //     </Left>
      //     <Right>
      //       <InstagramText>{this.state.playbackInstanceName}</InstagramText>
      //     </Right>
      //     <Image
